...
### BambuControll
Python/PyPI library for working with Bambu 3D printers.

- connects software with a real 3D printer workflow
...
### Self-hosted AI / Linux server setup
Personal server setup with Linux, Docker, Proxmox, Ollama, LiteLLM/Hermes and AI agent workflows.

- practical system administration and service integration
- local/self-hosted AI experimentation
- automation between tools and services

### Home Assistant / IoT automations
Personal automations connecting devices, rules and software logic into useful real-world workflows.

## What I'm looking for

I'm interested in student work around:

- Python backend development
- APIs and web applications
- embedded / IoT systems
- automation and practical technical systems
- useful AI integrations

My strength is practical problem-solving: I build projects, connect systems and learn new tools fast.

## Contact

- GitHub: https://github.com/LukaCek
- Email: cek.luka10@gmail.com
